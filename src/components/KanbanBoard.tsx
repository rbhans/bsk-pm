...
const KANBAN_COLUMNS: { status: KanbanStatus; title: string; color: string }[] = [
  ...
  { status: 'review', title: 'Review', color: 'bg-yellow-50 border-yellow-300' },
  { status: 'completed', title: 'Completed', color: 'bg-green-50 border-green-300' },
]
            ...
            {getProjectsByStatus(column.status).map(project => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <GripVertical size={16} className="text-gray-400 flex-shrink-0 ml-2" />
                </div>
                {project.description && (
